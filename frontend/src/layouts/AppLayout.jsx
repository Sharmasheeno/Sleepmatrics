...
const AppLayout = ({ theme, toggleTheme }) => {
  ...
  const navItems = [
    { name: 'Predict', icon: Home, path: '/' },
    { name: 'My History', icon: BarChart2, path: '/history' },
  ...
  return (
    <div className="flex h-screen w-full bg-light-bg text-light-text dark:bg-dark-bg dark:text-dark-text">
      ...
      <div className="flex flex-1 flex-col lg:pl-64">
        ...
        {/* --- Page Content --- */}
        <main className="flex-1 overflow-y-auto bg-light-bg p-4 md:p-8 lg:p-12 dark:bg-dark-bg">
          <Outlet />
        </main>
      </div>
